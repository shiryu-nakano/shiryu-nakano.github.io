...
## Week 26
![](../../../../../static/images/misc/Pasted%20image%2020260622101348.png)
...
---
**22 Mon**  |
- [X] ~~*GxP提出*~~ [2026-06-22 16:45]
- [ ] Bayes 再実装の確認
- [ ] H 実装
	- [ ] https://journals.aps.org/prl/pdf/10.1103/PhysRevLett.99.138103
- [ ] GCI　提出
- [ ] Deep 提出
**23 Tue** | H MTG, ELSI 発表，seminar，Bayes MTG


---
実質的に水曜日〜金曜日で進捗の大半を産む必要がある．
- LLC→ DSBデータの提示アルゴリズムができればOK，accとllcの推定を見たい
- bayes→火曜日に決まる
- honda→火曜日にできなかったこと
- 研究を進める
	- テーマがふわふわしている
**24 Wed**　
- [ ] AI for Scienceの出願
	- [ ] まず要項を全てダウンロードしてリポジトリに保存する．リポジトリはいつものやつ．
	- [ ] 
...
**直近作成する資料**
- [X] ~~*ELSI①*~~ [2026-06-29 00:27]
	- [X] ~~*下書きはOK*~~ [2026-06-29 00:27]
	- [X] ~~*細かい部分の説明を加える*~~ [2026-06-29 00:27]
- [ ] ELSI②；研究紹介
